...
const menuCategories = ["All", "Cakes", "Pastries", "Desserts", "Combos"];
...
const menuItems = [
  ...
  },
  {
    ...
    description: "Cheesecake + Croissant + Panna Cotta + Donuts",
    price: 649,
    category: "Combos",
  ...
  },
  {
    ...
    description: "Full Cake + 6 Cupcakes + Rose Milk Pudding",
    price: 899,
    category: "Combos",
